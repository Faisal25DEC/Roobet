    ...
    <div className=" grid grid-cols-1 lg:grid-cols-2 gap-4 pb-10">
      ...
      <div className="relative h-[160px] card">
        <div className="absolute w-full h-full card-1">
          <h1 className="text-shadow text-white text-[40px] font-[600] absolute bottom-2 left-8">
            Slotlar
          </h1>
        </div>
      ...
      <div className="relative h-[160px] card">
        <div className="absolute w-full h-full card-5">
          <h1 className="text-white text-[40px] font-[600] absolute bottom-2 left-8 text-shadow">
            Cakilma Oyunlari
          </h1>
        </div>
